...
#define DCMIPP_VERIFY_PIPE1_TRANSFORM_EXTRA_EOF 3U
#define DCMIPP_VERIFY_PIPE1_TAIL_READY_LINES 16U
/*
 * Scale validation profiles:
 *   0: IMX219 640x480, no ISP decimation, no DCMIPP downsize.
 *   1: IMX219 1640x1232 binning, PIPE crop to 640x480, no decimation/downsize.
 *   2: IMX219 1640x1232 binning + ISP decimation only, output 820x616.
 *   3: IMX219 1640x1232 binning + RawBayer2RGB + DCMIPP downsize, output 640x480.
 *   4: IMX219 1640x1232 binning + ISP decimation + DCMIPP downsize, output 640x480.
 *   5: IMX219 1640x1232 binning + RawBayer2RGB only, observed output 820x320.
 *   6: IMX219 1640x1232 binning + RawBayer2RGB observed 820x320 + downsize to 640x240.
 *   7: IMX219 1640x1232 binning + PIPE0 RAW16 crop dump, output 640x480.
 */
#define DCMIPP_VERIFY_SCALE_PROFILE 3U

#if (DCMIPP_VERIFY_SCALE_PROFILE == 0U)
#define IMX219_DEBUG_RESOLUTION IMX219_R640_480
#define DCMIPP_VERIFY_WIDTH 640U
#define DCMIPP_VERIFY_HEIGHT 480U
#define DCMIPP_VERIFY_ENABLE_ISP_DECIMATION 0U
#define DCMIPP_VERIFY_ENABLE_DOWNSIZE 0U
#define DCMIPP_VERIFY_ENABLE_CROP 0U
#define DCMIPP_VERIFY_PROFILE_OUTPUT_WIDTH DCMIPP_VERIFY_WIDTH
#define DCMIPP_VERIFY_PROFILE_OUTPUT_HEIGHT DCMIPP_VERIFY_HEIGHT
#elif (DCMIPP_VERIFY_SCALE_PROFILE == 1U)
#define IMX219_DEBUG_RESOLUTION IMX219_R1640_1232
#define DCMIPP_VERIFY_WIDTH 1640U
#define DCMIPP_VERIFY_HEIGHT 1232U
#define DCMIPP_VERIFY_ENABLE_ISP_DECIMATION 0U
#define DCMIPP_VERIFY_ENABLE_DOWNSIZE 0U
#define DCMIPP_VERIFY_ENABLE_CROP 1U
#define DCMIPP_VERIFY_PROFILE_OUTPUT_WIDTH 640U
#define DCMIPP_VERIFY_PROFILE_OUTPUT_HEIGHT 480U
#elif (DCMIPP_VERIFY_SCALE_PROFILE == 2U)
#define IMX219_DEBUG_RESOLUTION IMX219_R1640_1232
#define DCMIPP_VERIFY_WIDTH 1640U
#define DCMIPP_VERIFY_HEIGHT 1232U
#define DCMIPP_VERIFY_ENABLE_ISP_DECIMATION 1U
#define DCMIPP_VERIFY_ENABLE_DOWNSIZE 0U
#define DCMIPP_VERIFY_ENABLE_CROP 0U
#define DCMIPP_VERIFY_PROFILE_OUTPUT_WIDTH 820U
#define DCMIPP_VERIFY_PROFILE_OUTPUT_HEIGHT 616U
#elif (DCMIPP_VERIFY_SCALE_PROFILE == 3U)
#define IMX219_DEBUG_RESOLUTION IMX219_R1640_1232
#define DCMIPP_VERIFY_WIDTH 1640U
#define DCMIPP_VERIFY_HEIGHT 1232U
#define DCMIPP_VERIFY_ENABLE_ISP_DECIMATION 0U
...
#define DCMIPP_VERIFY_PROFILE_OUTPUT_WIDTH 640U
#define DCMIPP_VERIFY_PROFILE_OUTPUT_HEIGHT 480U
#elif (DCMIPP_VERIFY_SCALE_PROFILE == 4U)
#define IMX219_DEBUG_RESOLUTION IMX219_R1640_1232
#define DCMIPP_VERIFY_WIDTH 1640U
#define DCMIPP_VERIFY_HEIGHT 1232U
#define DCMIPP_VERIFY_ENABLE_ISP_DECIMATION 1U
...
#define DCMIPP_VERIFY_PROFILE_OUTPUT_WIDTH 640U
#define DCMIPP_VERIFY_PROFILE_OUTPUT_HEIGHT 480U
#elif (DCMIPP_VERIFY_SCALE_PROFILE == 5U)
#define IMX219_DEBUG_RESOLUTION IMX219_R1640_1232
#define DCMIPP_VERIFY_WIDTH 1640U
#define DCMIPP_VERIFY_HEIGHT 1232U
#define DCMIPP_VERIFY_ENABLE_ISP_DECIMATION 0U
...
#define DCMIPP_VERIFY_ENABLE_CROP 0U
#define DCMIPP_VERIFY_PROFILE_OUTPUT_WIDTH 820U
#define DCMIPP_VERIFY_PROFILE_OUTPUT_HEIGHT 320U
#elif (DCMIPP_VERIFY_SCALE_PROFILE == 6U)
#define IMX219_DEBUG_RESOLUTION IMX219_R1640_1232
#define DCMIPP_VERIFY_WIDTH 1640U
#define DCMIPP_VERIFY_HEIGHT 1232U
#define DCMIPP_VERIFY_ENABLE_ISP_DECIMATION 0U
...
#define DCMIPP_VERIFY_ENABLE_CROP 0U
#define DCMIPP_VERIFY_PROFILE_OUTPUT_WIDTH 640U
#define DCMIPP_VERIFY_PROFILE_OUTPUT_HEIGHT 240U
#elif (DCMIPP_VERIFY_SCALE_PROFILE == 7U)
#define IMX219_DEBUG_RESOLUTION IMX219_R1640_1232
#define DCMIPP_VERIFY_WIDTH 1640U
#define DCMIPP_VERIFY_HEIGHT 1232U
#define DCMIPP_VERIFY_ENABLE_ISP_DECIMATION 0U
...
#define DCMIPP_VERIFY_PROFILE_OUTPUT_HEIGHT 480U
#else
#error "Unsupported DCMIPP_VERIFY_SCALE_PROFILE"
#endif

#define DCMIPP_VERIFY_CROP_WIDTH 640U
#define DCMIPP_VERIFY_CROP_HEIGHT 480U
#define DCMIPP_VERIFY_ISP_DECIMATED_WIDTH (DCMIPP_VERIFY_WIDTH / 2U)
#define DCMIPP_VERIFY_ISP_DECIMATED_HEIGHT (DCMIPP_VERIFY_HEIGHT / 2U)
#define DCMIPP_VERIFY_BAYER2RGB_WIDTH (DCMIPP_VERIFY_WIDTH / 2U)
#define DCMIPP_VERIFY_BAYER2RGB_HEIGHT (DCMIPP_VERIFY_HEIGHT / 2U)
#define DCMIPP_VERIFY_BAYER2RGB_OBSERVED_HEIGHT 320U
#if (DCMIPP_VERIFY_ENABLE_DOWNSIZE != 0U)
#define DCMIPP_VERIFY_OUTPUT_WIDTH DCMIPP_VERIFY_PROFILE_OUTPUT_WIDTH
#define DCMIPP_VERIFY_OUTPUT_HEIGHT DCMIPP_VERIFY_PROFILE_OUTPUT_HEIGHT
#elif (DCMIPP_VERIFY_ENABLE_CROP != 0U)
#define DCMIPP_VERIFY_OUTPUT_WIDTH DCMIPP_VERIFY_CROP_WIDTH
#define DCMIPP_VERIFY_OUTPUT_HEIGHT DCMIPP_VERIFY_CROP_HEIGHT
#elif (DCMIPP_VERIFY_SCALE_PROFILE == 5U)
#define DCMIPP_VERIFY_OUTPUT_WIDTH DCMIPP_VERIFY_PROFILE_OUTPUT_WIDTH
#define DCMIPP_VERIFY_OUTPUT_HEIGHT DCMIPP_VERIFY_PROFILE_OUTPUT_HEIGHT
#elif ((DCMIPP_VERIFY_ENABLE_ISP_DECIMATION != 0U) || (DCMIPP_VERIFY_SCALE_PROFILE == 3U))
#define DCMIPP_VERIFY_OUTPUT_WIDTH DCMIPP_VERIFY_ISP_DECIMATED_WIDTH
#define DCMIPP_VERIFY_OUTPUT_HEIGHT DCMIPP_VERIFY_ISP_DECIMATED_HEIGHT
#else
...
#define DCMIPP_VERIFY_ALIGN_UP(V, A) ((((V) + ((A) - 1U)) / (A)) * (A))
#define DCMIPP_VERIFY_RGB565_ACTIVE_LINE_BYTES (DCMIPP_VERIFY_OUTPUT_WIDTH * 2U)
#define DCMIPP_VERIFY_RGB565_LINE_BYTES DCMIPP_VERIFY_RGB565_ACTIVE_LINE_BYTES
#define DCMIPP_VERIFY_LINE_PITCH DCMIPP_VERIFY_ALIGN_UP(DCMIPP_VERIFY_RGB565_ACTIVE_LINE_BYTES, 16U)
...
#define DCMIPP_VERIFY_RGB565_FRAME_BYTES (DCMIPP_VERIFY_LINE_PITCH * DCMIPP_VERIFY_OUTPUT_HEIGHT)
...
#define DCMIPP_VERIFY_ISP_DECIMATION_H DCMIPP_HDEC_1_OUT_2
#define DCMIPP_VERIFY_ISP_DECIMATION_V DCMIPP_VDEC_1_OUT_2
#if (DCMIPP_VERIFY_ENABLE_ISP_DECIMATION != 0U)
#define DCMIPP_VERIFY_DOWNSIZE_SOURCE_WIDTH (DCMIPP_VERIFY_BAYER2RGB_WIDTH / 2U)
#define DCMIPP_VERIFY_DOWNSIZE_SOURCE_HEIGHT (DCMIPP_VERIFY_BAYER2RGB_HEIGHT / 2U)
#elif (DCMIPP_VERIFY_SCALE_PROFILE == 3U)
#define DCMIPP_VERIFY_DOWNSIZE_SOURCE_WIDTH DCMIPP_VERIFY_BAYER2RGB_WIDTH
#define DCMIPP_VERIFY_DOWNSIZE_SOURCE_HEIGHT DCMIPP_VERIFY_BAYER2RGB_HEIGHT
#elif (DCMIPP_VERIFY_SCALE_PROFILE == 6U)
#define DCMIPP_VERIFY_DOWNSIZE_SOURCE_WIDTH DCMIPP_VERIFY_BAYER2RGB_WIDTH
#define DCMIPP_VERIFY_DOWNSIZE_SOURCE_HEIGHT DCMIPP_VERIFY_BAYER2RGB_OBSERVED_HEIGHT
#else
#define DCMIPP_VERIFY_DOWNSIZE_SOURCE_WIDTH DCMIPP_VERIFY_BAYER2RGB_WIDTH
#define DCMIPP_VERIFY_DOWNSIZE_SOURCE_HEIGHT DCMIPP_VERIFY_BAYER2RGB_HEIGHT
#endif
...
#define DCMIPP_VERIFY_PHY_BITRATE DCMIPP_CSI_PHY_BT_450
...
#if (DCMIPP_VERIFY_SCALE_PROFILE == 7U)
#define DCMIPP_VERIFY_CAPTURE_PIPE DCMIPP_PIPE0
#else
#define DCMIPP_VERIFY_CAPTURE_PIPE DCMIPP_PIPE1
#endif
#define DCMIPP_VERIFY_CAPTURE_MODE DCMIPP_MODE_SNAPSHOT
#if (DCMIPP_VERIFY_CAPTURE_MODE == DCMIPP_MODE_SNAPSHOT)
#define DCMIPP_VERIFY_FREEZE_AFTER_FRAMES 1U
#else
...
#if (DCMIPP_VERIFY_SCALE_PROFILE == 7U)
#define DCMIPP_VERIFY_PIPE0_LIMIT_WORDS DCMIPP_VERIFY_FRAME_WORDS
#else
...
#define DCMIPP_VERIFY_PIPE0_CROP DCMIPP_VERIFY_ENABLE_CROP
#define DCMIPP_VERIFY_PIPE0_CROP_HSTART 0U
#define DCMIPP_VERIFY_PIPE0_CROP_VSTART 0U
#define DCMIPP_VERIFY_PIPE0_CROP_HSIZE DCMIPP_VERIFY_CROP_WIDTH
#define DCMIPP_VERIFY_PIPE0_CROP_VSIZE DCMIPP_VERIFY_CROP_HEIGHT
...
#define DCMIPP_VERIFY_DUMP_RAW16_LAYOUT 1U
#define DCMIPP_VERIFY_DUMP_RGB565_LAYOUT 0U
#else
...
#define DCMIPP_VERIFY_PIPE1_ENABLE_BLACK_LEVEL 0U
#define DCMIPP_VERIFY_PIPE1_ENABLE_EXPOSURE 0U
#define DCMIPP_VERIFY_PIPE1_ENABLE_GAMMA 0U
...
static volatile uint32_t dcmipp_p0_limit_irq_count;
static volatile uint32_t dcmipp_p0_limit_tick;
static volatile uint32_t dcmipp_p0_limit_dccntr;
...
static volatile uint32_t dcmipp_p0_cscstr;
static volatile uint32_t dcmipp_p0_cscszr;
static volatile uint32_t dcmipp_p1_fscr;
static volatile uint32_t dcmipp_p1_fctcr;
static volatile uint32_t dcmipp_p1_dmcr;
static volatile uint32_t dcmipp_p1_srcr;
static volatile uint32_t dcmipp_p1_crstr;
static volatile uint32_t dcmipp_p1_crszr;
static volatile uint32_t dcmipp_p1_decr;
static volatile uint32_t dcmipp_p1_dccr;
...
static volatile uint32_t dcmipp_p1_cdccr;
static volatile uint32_t dcmipp_p1_cdscr;
static volatile uint32_t dcmipp_p1_cdsrtior;
static volatile uint32_t dcmipp_p1_cdsszr;
...
static volatile uint32_t dcmipp_buf_tail_samples;
static volatile uint32_t dcmipp_buf_tail_prefill;
static volatile uint32_t dcmipp_buf_tail_ready;
...
static uint32_t DCMIPP_BufferTailReady(void);
...
void CameraDebug_InitAndStart(I2C_HandleTypeDef *hi2c)
{
...
#if (CAMERA_DEBUG_I2C_ONLY == 0U)
  printf("DCMIPP: profile=%lu %lux%lu RAW10 on VC0, output=%lux%lu, lanes=%lu, lane_map=%lu, PHY BT index=%lu, PIPE%lu mode=0x%08lX freeze_after_frames=%lu buffer=%lu bytes/%lu words, raw10_in=%lu bytes/%lu words, pipe0_dump=%lu bytes/%lu words, pixel_packer=0x%08lX pitch=%lu, isp_decimation=%lu, downsize=%lu, p0_limit_words=%lu, p0_decimate=%lu byte_sel=0x%08lX line_sel=0x%08lX, crop=%lu crop_h=%lu crop_v=%lu, test_pattern=%lu, slow_timing=%lu line=%lu frame=%lu, low_link=%lu low_link_op_pll=0x%04lX, dtmode=%lu, dump_header=%lu, ipplug_cfg=%lu, cache_maint=%lu\r\n",
         (uint32_t)DCMIPP_VERIFY_SCALE_PROFILE,
         ...
         (uint32_t)DCMIPP_VERIFY_ENABLE_ISP_DECIMATION,
  ...
  if (DCMIPP_WaitForFrameComplete(DCMIPP_VERIFY_FRAME_DONE_TIMEOUT_MS) == 0U)
  {
    ...
    DCMIPP_UpdateBufferStats();
#if (DCMIPP_VERIFY_DUMP_RGB565_LAYOUT != 0U)
    if (dcmipp_rgb565_layout_dumped == 0U)
    {
      DCMIPP_DumpRGB565Layout();
      dcmipp_rgb565_layout_dumped = 1U;
    }
#endif
    if ((DCMIPP_VERIFY_CAPTURE_PIPE == DCMIPP_PIPE1) && (dcmipp_rgb565_valid != 0U))
    {
      printf("DCMIPP timeout fallback: RGB565 buffer has data, freezing for dump\r\n");
      DCMIPP_FreezeCaptureForDump();
      DCMIPP_LogPipeRegisters("timeout_rgb565_frozen");
      dcmipp_status = 3U;
      imx219_status = 7U;
      printf("CSI IMX219 bring-up PASS (timeout RGB565 freeze)\r\n");
      return;
    }
#if (DCMIPP_VERIFY_PHY_SCAN != 0U)
  ...
  DCMIPP_UpdateBufferStats();
#if (DCMIPP_VERIFY_DUMP_RAW16_LAYOUT != 0U)
  if (dcmipp_raw16_layout_dumped == 0U)
  {
...
if ((dcmipp_status == 4U) &&
    (dcmipp_capture_frozen == 0U) &&
    (dcmipp_frame_count >= DCMIPP_VERIFY_FREEZE_AFTER_FRAMES) &&
    (dcmipp_buf_tail_ready != 0U))
{
  if (dcmipp_frame_done_tick == 0U)
  {
    dcmipp_frame_done_tick = HAL_GetTick();
  }
  printf("DCMIPP late tail-ready freeze: frames=%lu tail=%lu/%lu tick=%lu\r\n",
         dcmipp_frame_count,
         dcmipp_buf_tail_prefill,
         dcmipp_buf_tail_samples,
         HAL_GetTick());
  DCMIPP_LogPipeRegisters("late_tail_ready_before_freeze");
  DCMIPP_FreezeCaptureForDump();
  DCMIPP_LogPipeRegisters("late_tail_ready_frozen");
  dcmipp_status = 3U;
  imx219_status = 7U;
  printf("CSI IMX219 bring-up PASS (late tail-ready)\r\n");
}
#if (DCMIPP_VERIFY_DUMP_RAW16_LAYOUT != 0U)
if ((dcmipp_raw16_layout_dumped == 0U) &&
    ((dcmipp_p0_limit_irq_count != 0U) || (dcmipp_p0_dccntr >= DCMIPP_VERIFY_FRAME_BYTES)))
{
  DCMIPP_DumpRaw16Layout();
  dcmipp_raw16_layout_dumped = 1U;
}
...
#endif
printf("heartbeat=%lu imx219=%lu stream=%s frozen=%lu done_tick=%lu freeze_tick=%lu dcmipp=%lu pipe=%lu frames=%lu hw=%lu dump=%lu/%lu buf_changed=%lu tail=%lu/%lu ready=%lu raw16=%lu align=%lu raw16_min=0x%04lX raw16_max=0x%04lX raw16_s=%04lX,%04lX,%04lX,%04lX rgb565=%lu r5=0x%02lX..0x%02lX g6=0x%02lX..0x%02lX b5=0x%02lX..0x%02lX s=%04lX,%04lX,%04lX,%04lX vsync=%lu sof=%lu eof=%lu err=0x%08lX p1_ovr=%lu post_frame_ovr=%lu csi_err1=0x%08lX csi_err2=0x%08lX p0sr=0x%08lX p1sr=0x%08lX p1decr=0x%08lX p1dccr=0x%08lX p1cdccr=0x%08lX p1cdscr=0x%08lX p1cdsrtior=0x%08lX p1cdsszr=0x%08lX sr0=0x%08lX sr1=0x%08lX\r\n",
       ...
       (uint32_t)DCMIPP_VERIFY_FRAME_BYTES,
       dcmipp_buf_changed,
       dcmipp_buf_tail_prefill, dcmipp_buf_tail_samples, dcmipp_buf_tail_ready,
       dcmipp_raw16_valid, dcmipp_raw16_align, dcmipp_raw16_min, dcmipp_raw16_max,
       ...
       dcmipp_csi_err1, dcmipp_csi_err2,
       dcmipp_p0_sr, dcmipp_p1_sr,
       dcmipp_p1_decr, dcmipp_p1_dccr, dcmipp_p1_cdccr,
       dcmipp_p1_cdscr, dcmipp_p1_cdsrtior, dcmipp_p1_cdsszr,
       dcmipp_csi_sr0, dcmipp_csi_sr1);
#if 0
...
static void MX_DCMIPP_Init(void)
{
...
#endif
#if (DCMIPP_VERIFY_PIPE0_CROP != 0U)
  ...
  {
#if (DCMIPP_VERIFY_ENABLE_ISP_DECIMATION != 0U)
    isp_decimation_conf.HRatio = DCMIPP_VERIFY_ISP_DECIMATION_H;
    isp_decimation_conf.VRatio = DCMIPP_VERIFY_ISP_DECIMATION_V;
    if (HAL_DCMIPP_PIPE_SetISPDecimationConfig(&hdcmipp,
                                               DCMIPP_VERIFY_CAPTURE_PIPE,
                                               &isp_decimation_conf) != HAL_OK)
    {
      Error_Handler();
    }
    if (HAL_DCMIPP_PIPE_EnableISPDecimation(&hdcmipp, DCMIPP_VERIFY_CAPTURE_PIPE) != HAL_OK)
    {
      Error_Handler();
    }
#else
    (void)HAL_DCMIPP_PIPE_DisableISPDecimation(&hdcmipp, DCMIPP_VERIFY_CAPTURE_PIPE);
#endif
    (void)HAL_DCMIPP_PIPE_DisableDecimation(&hdcmipp, DCMIPP_VERIFY_CAPTURE_PIPE);
    ...
    downsize_conf.HRatio = DCMIPP_DOWNSIZE_RATIO(DCMIPP_VERIFY_DOWNSIZE_SOURCE_WIDTH, DCMIPP_VERIFY_OUTPUT_WIDTH);
    downsize_conf.VRatio = DCMIPP_DOWNSIZE_RATIO(DCMIPP_VERIFY_DOWNSIZE_SOURCE_HEIGHT, DCMIPP_VERIFY_OUTPUT_HEIGHT);
    downsize_conf.HDivFactor = DCMIPP_DOWNSIZE_DIV_FACTOR(DCMIPP_VERIFY_DOWNSIZE_SOURCE_WIDTH, DCMIPP_VERIFY_OUTPUT_WIDTH);
    downsize_conf.VDivFactor = DCMIPP_DOWNSIZE_DIV_FACTOR(DCMIPP_VERIFY_DOWNSIZE_SOURCE_HEIGHT, DCMIPP_VERIFY_OUTPUT_HEIGHT);
...
static uint32_t DCMIPP_WaitForFrameComplete(uint32_t TimeoutMs)
{
...
#if ((DCMIPP_VERIFY_ENABLE_DOWNSIZE != 0U) || (DCMIPP_VERIFY_ENABLE_ISP_DECIMATION != 0U) || (DCMIPP_VERIFY_ENABLE_CROP != 0U))
  uint32_t eof_start = dcmipp_eof_count;
#endif
  ...
  do
  {
    ...
    if (dcmipp_frame_count >= DCMIPP_VERIFY_FREEZE_AFTER_FRAMES)
    {
      ...
      if (DCMIPP_VERIFY_CAPTURE_PIPE == DCMIPP_PIPE0)
      {
        complete = ((dcmipp_p0_limit_irq_count != 0U) ||
                    (dcmipp_p0_dccntr >= DCMIPP_VERIFY_FRAME_BYTES)) ? 1U : 0U;
      }
      else
      {
        complete = (((dcmipp_p1_sr & DCMIPP_P1SR_FRAMEF) != 0U) &&
                    ((dcmipp_p1_sr & DCMIPP_P1SR_LSTFRM) != 0U)) ? 1U : 0U;
#if ((DCMIPP_VERIFY_ENABLE_DOWNSIZE != 0U) || (DCMIPP_VERIFY_ENABLE_ISP_DECIMATION != 0U) || (DCMIPP_VERIFY_ENABLE_CROP != 0U))
        if ((complete == 0U) &&
            ((dcmipp_p1_sr & DCMIPP_P1SR_FRAMEF) != 0U) &&
            ((dcmipp_eof_count - eof_start) >= DCMIPP_VERIFY_PIPE1_TRANSFORM_EXTRA_EOF))
        {
          complete = 1U;
        }
#endif
        if (complete != 0U)
        {
          complete = DCMIPP_BufferTailReady();
        }
      }
...
static void DCMIPP_FreezeCaptureForDump(void)
{
  uint16_t mode = 0xFFFFU;
  uint32_t pipe_idle;
  uint32_t sensor_stopped_before_pipe = 0U;
  uint32_t fast_pipe0_limit_freeze =
    ((DCMIPP_VERIFY_CAPTURE_PIPE == DCMIPP_PIPE0) && (dcmipp_p0_limit_irq_count != 0U)) ? 1U : 0U;
...
#if (IMX219_DEBUG_START_STREAM != 0U)
  if ((fast_pipe0_limit_freeze == 0U) &&
      ((DCMIPP_VERIFY_CAPTURE_MODE == DCMIPP_MODE_CONTINUOUS)
#if ((DCMIPP_VERIFY_ENABLE_DOWNSIZE != 0U) || (DCMIPP_VERIFY_ENABLE_ISP_DECIMATION != 0U) || (DCMIPP_VERIFY_ENABLE_CROP != 0U))
      || (DCMIPP_VERIFY_CAPTURE_PIPE == DCMIPP_PIPE1)
#endif
     ))
  {
    if (IMX219_Stop(&hcamera) != IMX219_OK)
    {
      printf("IMX219 stream OFF failed before PIPE freeze\r\n");
    }
    else
    {
      imx219_streaming = 0U;
      sensor_stopped_before_pipe = 1U;
      if ((DCMIPP_VERIFY_CAPTURE_PIPE != DCMIPP_PIPE0) ||
          (dcmipp_p0_limit_irq_count == 0U))
      {
  ...
  else if (HAL_DCMIPP_CSI_PIPE_Stop(&hdcmipp, DCMIPP_VERIFY_CAPTURE_PIPE, DCMIPP_VIRTUAL_CHANNEL0) != HAL_OK)
  {
    dcmipp_last_error = HAL_DCMIPP_GetError(&hdcmipp);
...
#if (IMX219_DEBUG_START_STREAM != 0U)
  if (sensor_stopped_before_pipe == 0U)
  {
    if (IMX219_Stop(&hcamera) != IMX219_OK)
    {
...
{
  DCMIPP_SampleCsiFlags();
  printf("DCMIPP PIPE%lu %s: configured_input=%lux%lu output=%lux%lu downsize_src=%lux%lu raw10_line_bytes=%lu pitch=%lu raw10_frame=%lu frame_bytes=%lu buffer=%lu p0fscr=0x%08lX p0fctcr=0x%08lX p0ppcr=0x%08lX p0dclmtr=0x%08lX p0limit_irq=%lu p0limit_tick=%lu p0limit_dcc=%lu p0m0ar1=0x%08lX p0stm0ar=0x%08lX p0scstr=0x%08lX p0scszr=0x%08lX p0cscstr=0x%08lX p0cscszr=0x%08lX p0dcc_bytes=%lu p0sr=0x%08lX p1fscr=0x%08lX p1fctcr=0x%08lX p1dmcr=0x%08lX p1srcr=0x%08lX p1crstr=0x%08lX p1crszr=0x%08lX p1dscr=0x%08lX p1dsrtior=0x%08lX p1dsszr=0x%08lX p1cdscr=0x%08lX p1cdsrtior=0x%08lX p1cdsszr=0x%08lX p1ppcr=0x%08lX p1m0ar1=0x%08lX p1m0pr=0x%08lX p1stm0ar=0x%08lX p1sr=0x%08lX p1_ovr=%lu sr0=0x%08lX sr1=0x%08lX csi_err1=0x%08lX csi_err2=0x%08lX spdfr=0x%08lX csi_prcr=0x%08lX csi_pmcr=0x%08lX dt=0x%02lX vc=0 downsize=%lu crop=%lu decimate=%lu pixel_packer=0x%08lX header=%lu\r\n",
         (uint32_t)DCMIPP_VERIFY_CAPTURE_PIPE,
         Tag,
         ...
         (uint32_t)DCMIPP_VERIFY_DOWNSIZE_SOURCE_WIDTH,
         (uint32_t)DCMIPP_VERIFY_DOWNSIZE_SOURCE_HEIGHT,
         ...
         dcmipp_p0_ppcr,
         dcmipp_p0_dclmtr,
         dcmipp_p0_limit_irq_count,
         dcmipp_p0_limit_tick,
         dcmipp_p0_limit_dccntr,
         dcmipp_p0_ppm0ar1,
         dcmipp_p0_stm0ar,
         dcmipp_p0_scstr,
         dcmipp_p0_scszr,
...
void HAL_DCMIPP_PIPE_LimitEventCallback(DCMIPP_HandleTypeDef *hdcmipp_cb, uint32_t Pipe)
{
  ...
  if ((Pipe == DCMIPP_PIPE0) && (DCMIPP_VERIFY_CAPTURE_PIPE == DCMIPP_PIPE0))
  {
    dcmipp_p0_limit_irq_count++;
    dcmipp_p0_limit_tick = HAL_GetTick();
    dcmipp_p0_limit_dccntr = DCMIPP->P0DCCNTR;
    CLEAR_BIT(DCMIPP->P0FCTCR, DCMIPP_P0FCTCR_CPTREQ);
    CLEAR_BIT(DCMIPP->P0FSCR, DCMIPP_P0FSCR_PIPEN);
  }
}
...
static void DCMIPP_SampleCsiFlags(void)
{
  ...
  dcmipp_p0_cscstr = DCMIPP->P0CSCSTR;
  dcmipp_p0_cscszr = DCMIPP->P0CSCSZR;
  dcmipp_p1_fscr = DCMIPP->P1FSCR;
  dcmipp_p1_fctcr = DCMIPP->P1FCTCR;
  dcmipp_p1_dmcr = DCMIPP->P1DMCR;
  dcmipp_p1_srcr = DCMIPP->P1SRCR;
  dcmipp_p1_crstr = DCMIPP->P1CRSTR;
  dcmipp_p1_crszr = DCMIPP->P1CRSZR;
  dcmipp_p1_decr = DCMIPP->P1DECR;
  dcmipp_p1_dccr = DCMIPP->P1DCCR;
  dcmipp_p1_dscr = DCMIPP->P1DSCR;
  dcmipp_p1_dsrtior = DCMIPP->P1DSRTIOR;
  dcmipp_p1_dsszr = DCMIPP->P1DSSZR;
  dcmipp_p1_cdccr = DCMIPP->P1CDCCR;
  dcmipp_p1_cdscr = DCMIPP->P1CDSCR;
  dcmipp_p1_cdsrtior = DCMIPP->P1CDSRTIOR;
  dcmipp_p1_cdsszr = DCMIPP->P1CDSSZR;
...
static uint32_t DCMIPP_BufferTailReady(void)
{
  ...
  uint32_t tail_bytes = DCMIPP_VERIFY_PIPE1_TAIL_READY_LINES * DCMIPP_VERIFY_RGB565_LINE_BYTES;
  uint32_t start;
  uint32_t samples = 0U;
  uint32_t prefill = 0U;

  if (tail_bytes > DCMIPP_VERIFY_FRAME_BYTES)
  {
    tail_bytes = DCMIPP_VERIFY_FRAME_BYTES;
  }

  start = DCMIPP_VERIFY_FRAME_BYTES - tail_bytes;
  start &= ~3UL;

  DCMIPP_InvalidateBuffer();

  for (uint32_t i = start; (i + 3U) < DCMIPP_VERIFY_FRAME_BYTES; i += 4U)
  {
    uint32_t word = ((uint32_t)buf[i]) |
                    ((uint32_t)buf[i + 1U] << 8) |
                    ((uint32_t)buf[i + 2U] << 16) |
                    ((uint32_t)buf[i + 3U] << 24);
    samples++;
  ...
  dcmipp_buf_tail_samples = samples;
  dcmipp_buf_tail_prefill = prefill;
  dcmipp_buf_tail_ready = ((samples != 0U) && (prefill < (samples / 2U))) ? 1U : 0U;
  return dcmipp_buf_tail_ready;
}
...
#if (DCMIPP_VERIFY_CAPTURE_PIPE != DCMIPP_PIPE1)
  uint32_t raw16_sample_count = DCMIPP_VERIFY_OUTPUT_WIDTH * DCMIPP_VERIFY_OUTPUT_HEIGHT;
...
#if (DCMIPP_VERIFY_CAPTURE_PIPE == DCMIPP_PIPE1)
  for (uint32_t y = 0U; y < DCMIPP_VERIFY_OUTPUT_HEIGHT; y++)
  {
    for (uint32_t x = 0U; x < DCMIPP_VERIFY_OUTPUT_WIDTH; x++)
    {
      uint32_t byte_index = (y * DCMIPP_VERIFY_LINE_PITCH) + (x * 2U);
...
static void DCMIPP_DumpRaw16Layout(void)
{
  ...
  if (line_count > DCMIPP_VERIFY_OUTPUT_HEIGHT)
  {
    line_count = DCMIPP_VERIFY_OUTPUT_HEIGHT;
  }
  if (pixel_count > DCMIPP_VERIFY_OUTPUT_WIDTH)
  {
    pixel_count = DCMIPP_VERIFY_OUTPUT_WIDTH;
  }
  sample_count = DCMIPP_VERIFY_OUTPUT_WIDTH * DCMIPP_VERIFY_OUTPUT_HEIGHT;
  ...
  printf("RAW16 layout: frame_bytes=%lu stride_bytes=%lu pixels=%lux%lu scanned_lines=%lu printed_lines=%lu min_raw=0x%04lX max_raw=0x%04lX sat10=%lu/%lu nonzero_low6=%lu/%lu nonzero_high6=%lu/%lu first_high6_y=%lu first_high6_x=%lu hint=%s\r\n",
         ...
         nonzero_high6,
         sample_count,
         (first_high6_index == 0xFFFFFFFFU) ? 0xFFFFFFFFU : (first_high6_index / DCMIPP_VERIFY_OUTPUT_WIDTH),
         (first_high6_index == 0xFFFFFFFFU) ? 0xFFFFFFFFU : (first_high6_index % DCMIPP_VERIFY_OUTPUT_WIDTH),
  ...
  printf("RAW10R grid8x8:");
  for (uint32_t gy = 0U; gy < 8U; gy++)
  {
    uint32_t y = (gy * (DCMIPP_VERIFY_OUTPUT_HEIGHT - 1U)) / 7U;
    printf(" y%lu=", y);
    for (uint32_t gx = 0U; gx < 8U; gx++)
    {
      uint32_t x = (gx * (DCMIPP_VERIFY_OUTPUT_WIDTH - 1U)) / 7U;
      uint32_t byte_index = (y * DCMIPP_VERIFY_LINE_PITCH) + (x * 2U);
      uint32_t raw = ((uint32_t)buf[byte_index]) | ((uint32_t)buf[byte_index + 1U] << 8);
      printf("%03lX", raw & 0x03FFU);
      if (gx != 7U)
...
static void DCMIPP_DumpRGB565Layout(void)
{
  ...
  uint32_t sample_count = DCMIPP_VERIFY_OUTPUT_WIDTH * DCMIPP_VERIFY_OUTPUT_HEIGHT;
